...
export default function Hero() {
  ...
  return (
    <div className="isolate bg-white select-none lg:-mt-[5rem] mt-[5rem] sm:-mt-[5rem]">
      <div className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#2e5aec" />
              <stop offset={1} stopColor="#0003ba" />
            </linearGradient>
          </defs>
        </svg>
      </div>
      ...
      <main>
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{type: 'keyframes', duration: 1}} className="relative px-6 lg:px-8">
            ...
            <div>
              ...
              <div>
                ...
                <div className="mt-8 flex gap-x-4 sm:justify-center">
                  <a
                    href="https://calendly.com/support-rubilink"
                    target="_blank"
                    className="inline-block rounded-lg bg-sky-500 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-sky-400 ease-in-out duration-300"
                  >
                    Schedule Call
                    <span className="text-indigo-200 ml-2 hover:animate-wiggle" aria-hidden="true">
                      &rarr;
                    </span>
                  </a>
                </div>
