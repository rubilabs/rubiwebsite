      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16">
        <motion.div animate={animation} className="mx-auto max-w-2xl lg:mr-0 lg:ml-auto lg:w-1/2 lg:max-w-none lg:pl-10">
          ...
          <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            We tailor the data fetch and post based on your needs
          </h2>
          <p className="mt-6 text-lg text-gray-500">
            We process your post and fetch request through broadcasting system that is build within our blockchain. Rubilink system will automatically broadcast data directly to your system.
          </p>
