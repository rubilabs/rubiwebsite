...
export default function BlockchainDeveloper4() {
    ...
    <div className="w-full justify-center bg-white p-10">
        ...
        <div className="mt-12 md:flex items-center">
            ...
            <div className="flex flex-col md:ml-12 md:mt-0 mt-8">
                ...
                <input type="text" tabIndex={0} aria-label="Enter phone number" className="w-64 bg-gray-100 text-sm font-medium leading-none text-gray-800 p-3 border rounded border-gray-200" />
            </div>
        </div>
        <div className="mt-12 md:flex items-center">
            <div className="flex flex-col">
