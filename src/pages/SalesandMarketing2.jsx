...
export default function SalesandMarketing2() {
  ...
  return (
    ...
    <div className="w-full justify-center bg-white p-10">
        ...
        <a href='/salesandmarketing-3'><span className="text-sm font-medium text-center text-gray-800 capitalize">Next Step</span></a>
    ...
    <style aria-required dangerouslySetInnerHTML={{ __html: "\n          .checkbox:checked + .check-icon {\n              display: flex;\n          }\n      " }} />
    </div>
  )
}