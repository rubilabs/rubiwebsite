...
export default function SystemDesign2() {
  ...
  return (
    ...
    <div className="w-full justify-center bg-white p-10">
        ...
        <div aria-label="terms-and-conditions" role="terms" className="grid align-middle justify-center text-left m-4 overflow-y-scroll scroll-smooth w-1/2 h-[50vh]">
            ...
            <span aria-disabled={true} className="text-center">
        ...
        <a href='/systemdesign-3'><span className="text-sm font-medium text-center text-gray-800 capitalize">Next Step</span></a>
